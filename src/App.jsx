...
function App() {
  ...
  return (
    <div className="container">
      <header>
        <h1 className="firstTitle">Reliable, efficient delivery</h1>
        <h1 className="secondTitle">Powered by Technology</h1>
      ...
      <main>
        {data.map((e, i) => {
          return (
            <Card
              key={i}
              className={e.title!=="Team Builder"?e.title.toLowerCase():"teamBuilder"}
              title={e.title}
              content={e.content}
              icon={e.icon}
            ></Card>
